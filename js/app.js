...
const audioData = {
    ...
    rute66: {
        ...
        tracks: [
            { title: "Your closeness", src: "assets/audio/TRAVELLING BY ROUTE 66/01your closeness.mp3" },
            { title: "Variety and Laughters", src: "assets/audio/TRAVELLING BY ROUTE 66/02Variety and Laughters.mp3" },
            { title: "Some Distant Feeling", src: "assets/audio/TRAVELLING BY ROUTE 66/03Some Distant Feeling.mp3" },
            { title: "Traveling by Route 66", src: "assets/audio/TRAVELLING BY ROUTE 66/04Traveling by Route 66.mp3" },
            { title: "Chill Below Zero", src: "assets/audio/TRAVELLING BY ROUTE 66/05Chill Below Zero.mp3" },
            { title: "Your Closeness", src: "assets/audio/TRAVELLING BY ROUTE 66/06Your Closeness.mp3" },
            { title: "Surely It's love", src: "assets/audio/TRAVELLING BY ROUTE 66/07Surely It's love.mp3" },
            { title: "Much More Than a Friend", src: "assets/audio/TRAVELLING BY ROUTE 66/08Much More Than a Friend.mp3" },
            { title: "N.Y. Hispanic Woman", src: "assets/audio/TRAVELLING BY ROUTE 66/09N.Y. Hispanic Woman.mp3" },
            { title: "In My Cloud", src: "assets/audio/TRAVELLING BY ROUTE 66/10In My Cloud.mp3" },
            { title: "Between Mountains", src: "assets/audio/TRAVELLING BY ROUTE 66/11Between Mountains.mp3" },
            { title: "Good Atmosphere", src: "assets/audio/TRAVELLING BY ROUTE 66/12Good Atmosphere.mp3" },
            { title: "I Leave My Land", src: "assets/audio/TRAVELLING BY ROUTE 66/13I Leave My Land.mp3" },
            { title: "See You This Afternoon", src: "assets/audio/TRAVELLING BY ROUTE 66/14See You This Afternoon.mp3" }
        ]
    },
    aeswing: {
        title: "AESWING",
